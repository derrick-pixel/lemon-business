# Lemon-man (Counterparty Lemon Platform) — Architecture
...
- LIVE since 2026-05-19 at `derrick-pixel.github.io/lemon-business/`, but every page carries `noindex, nofollow` until commercial launch.
...
- `assets/css/lemon.css` (cache-busted via `?v=1`) — citrus B2B design system v2.
...
- `for-businesses.html` — "Un-lemon yourself": contesting the upload, ripening into a peach, free independent appeal.
...
- Public URL: `https://derrick-pixel.github.io/lemon-business/`.
...
- Cache-bust tokens are manual (`?v=1`) — easy to forget on CSS/JS edits.
...
- `/Users/derrickteo/codings/Lemon-man/Lemon Business_business_plan_v1.1.md` — business plan v1.1 (the version §7.5 of which rejected the MAD / blacklist mechanics that the current site re-introduces).
- `/Users/derrickteo/codings/Lemon-man/Legal Assessment of Project Lemon Business.pdf` — counsel's written assessment.
- `/Users/derrickteo/codings/Lemon-man/Lemon Business cowork_handoff_brief.md` — earlier handoff brief from the cowork session.
