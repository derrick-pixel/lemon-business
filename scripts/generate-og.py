#!/usr/bin/env python3
"""Generate the 1200x630 Open Graph card for Lemon Business.
...
# kicker
d.text((90, 150), "THE COUNTERPARTY LEMON PLATFORM", font=font(MONO, 24), fill=SOUR)

# wordmark
d.text((88, 222), "Lemon Business", font=font(SERIF, 90), fill=INK)
...
# tagline (two lines)
tag = font(SERIF, 52)
d.text((90, 404), "Stop dealing with", font=tag, fill=INK)
